...
// StockServiceMock implements mm_order.stockService
...
// NewStockServiceMock returns a mock for mm_order.stockService
...
func (mmReserve *mStockServiceMockReserve) Expect(ctx context.Context, items []domain.Item) *mStockServiceMockReserve {
...
func (mmReserve *mStockServiceMockReserve) ExpectItemsParam2(items []domain.Item) *mStockServiceMockReserve {
	if mmReserve.mock.funcReserve != nil {
		mmReserve.mock.t.Fatalf("StockServiceMock.Reserve mock is already set by Set")
	}
...
func (mmReserve *mStockServiceMockReserve) Inspect(f func(ctx context.Context, items []domain.Item)) *mStockServiceMockReserve {
...
func (mmReserve *mStockServiceMockReserve) Set(f func(ctx context.Context, items []domain.Item) (err error)) *StockServiceMock {
	if mmReserve.defaultExpectation != nil {
...
// Then helper
func (mmReserve *mStockServiceMockReserve) When(ctx context.Context, items []domain.Item) *StockServiceMockReserveExpectation {
	if mmReserve.mock.funcReserve != nil {
		mmReserve.mock.t.Fatalf("StockServiceMock.Reserve mock is already set by Set")
	}
...
// Reserve implements mm_order.stockService
func (mmReserve *StockServiceMock) Reserve(ctx context.Context, items []domain.Item) (err error) {
...
func (mmReserveCancel *mStockServiceMockReserveCancel) Expect(ctx context.Context, items []domain.Item) *mStockServiceMockReserveCancel {
...
func (mmReserveCancel *mStockServiceMockReserveCancel) ExpectItemsParam2(items []domain.Item) *mStockServiceMockReserveCancel {
	if mmReserveCancel.mock.funcReserveCancel != nil {
		mmReserveCancel.mock.t.Fatalf("StockServiceMock.ReserveCancel mock is already set by Set")
	}
...
func (mmReserveCancel *mStockServiceMockReserveCancel) Inspect(f func(ctx context.Context, items []domain.Item)) *mStockServiceMockReserveCancel {
...
func (mmReserveCancel *mStockServiceMockReserveCancel) Set(f func(ctx context.Context, items []domain.Item) (err error)) *StockServiceMock {
	if mmReserveCancel.defaultExpectation != nil {
...
// Then helper
func (mmReserveCancel *mStockServiceMockReserveCancel) When(ctx context.Context, items []domain.Item) *StockServiceMockReserveCancelExpectation {
	if mmReserveCancel.mock.funcReserveCancel != nil {
		mmReserveCancel.mock.t.Fatalf("StockServiceMock.ReserveCancel mock is already set by Set")
	}
...
// ReserveCancel implements mm_order.stockService
func (mmReserveCancel *StockServiceMock) ReserveCancel(ctx context.Context, items []domain.Item) (err error) {
...
func (mmReserveRemove *mStockServiceMockReserveRemove) Expect(ctx context.Context, items []domain.Item) *mStockServiceMockReserveRemove {
...
func (mmReserveRemove *mStockServiceMockReserveRemove) ExpectItemsParam2(items []domain.Item) *mStockServiceMockReserveRemove {
	if mmReserveRemove.mock.funcReserveRemove != nil {
		mmReserveRemove.mock.t.Fatalf("StockServiceMock.ReserveRemove mock is already set by Set")
	}
...
func (mmReserveRemove *mStockServiceMockReserveRemove) Inspect(f func(ctx context.Context, items []domain.Item)) *mStockServiceMockReserveRemove {
...
func (mmReserveRemove *mStockServiceMockReserveRemove) Set(f func(ctx context.Context, items []domain.Item) (err error)) *StockServiceMock {
	if mmReserveRemove.defaultExpectation != nil {
...
// Then helper
func (mmReserveRemove *mStockServiceMockReserveRemove) When(ctx context.Context, items []domain.Item) *StockServiceMockReserveRemoveExpectation {
	if mmReserveRemove.mock.funcReserveRemove != nil {
		mmReserveRemove.mock.t.Fatalf("StockServiceMock.ReserveRemove mock is already set by Set")
	}
...
// ReserveRemove implements mm_order.stockService
func (mmReserveRemove *StockServiceMock) ReserveRemove(ctx context.Context, items []domain.Item) (err error) {
